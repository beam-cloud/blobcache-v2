...
func (x *StoreContentFromSourceRequest) GetCompress() bool {
	if x != nil {
		return x.Compress
	}
	return false
...
var file_blobcache_proto_rawDesc = []byte{
	...
	0x76, 0x61, 0x74, 0x65, 0x49, 0x70, 0x41, 0x64, 0x64, 0x72, 0x22, 0x81, 0x01, 0x0a, 0x1d, 0x53,
	...
	0x0d, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f, 0x6f, 0x66, 0x66, 0x73, 0x65, 0x74, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x03, 0x52, 0x0c, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x4f, 0x66, 0x66, 0x73,
	0x65, 0x74, 0x12, 0x1a, 0x0a, 0x08, 0x63, 0x6f, 0x6d, 0x70, 0x72, 0x65, 0x73, 0x73, 0x18, 0x03,
	0x20, 0x01, 0x28, 0x08, 0x52, 0x08, 0x63, 0x6f, 0x6d, 0x70, 0x72, 0x65, 0x73, 0x73, 0x22, 0x44,
	...
	0x68, 0x61, 0x73, 0x68, 0x32, 0xe5, 0x02, 0x0a, 0x09, 0x42, 0x6c, 0x6f, 0x62, 0x43, 0x61, 0x63,
...
var file_blobcache_proto_depIdxs = []int32{
	...
	6, // 2: blobcache.BlobCache.StoreContentFromSource:input_type -> blobcache.StoreContentFromSourceRequest
	4, // 3: blobcache.BlobCache.GetState:input_type -> blobcache.GetStateRequest
	1, // 4: blobcache.BlobCache.GetContent:output_type -> blobcache.GetContentResponse
	3, // 5: blobcache.BlobCache.StoreContent:output_type -> blobcache.StoreContentResponse
	7, // 6: blobcache.BlobCache.StoreContentFromSource:output_type -> blobcache.StoreContentFromSourceResponse
	5, // 7: blobcache.BlobCache.GetState:output_type -> blobcache.GetStateResponse
