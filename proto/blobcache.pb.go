...
var file_blobcache_proto_rawDesc = []byte{
	...
	0x73, 0x68, 0x32, 0xad, 0x01, 0x0a, 0x09, 0x42, 0x6c, 0x6f, 0x62, 0x43, 0x61, 0x63, 0x68, 0x65,
...
var file_blobcache_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
...
var file_blobcache_proto_depIdxs = []int32{
	...
	1, // 2: blobcache.BlobCache.GetContent:output_type -> blobcache.GetContentResponse
	3, // 3: blobcache.BlobCache.StoreContent:output_type -> blobcache.StoreContentResponse
