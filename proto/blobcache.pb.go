...
var file_blobcache_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x04, 0x68, 0x61, 0x73, 0x68, 0x32, 0xb3, 0x04, 0x0a, 0x09, 0x42, 0x6c, 0x6f, 0x62,
	...
	0x72, 0x63, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x77, 0x0a,
	...
	0x2d, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2f, 0x62, 0x6c, 0x6f, 0x62, 0x63, 0x61, 0x63, 0x68, 0x65,
...
var file_blobcache_proto_depIdxs = []int32{
	...
	6, // 4: blobcache.BlobCache.StoreContentFromSourceWithLock:input_type -> blobcache.StoreContentFromSourceRequest
	4, // 5: blobcache.BlobCache.GetState:input_type -> blobcache.GetStateRequest
	...
	7, // 9: blobcache.BlobCache.StoreContentFromSource:output_type -> blobcache.StoreContentFromSourceResponse
	7, // 10: blobcache.BlobCache.StoreContentFromSourceWithLock:output_type -> blobcache.StoreContentFromSourceResponse
	5, // 11: blobcache.BlobCache.GetState:output_type -> blobcache.GetStateResponse
